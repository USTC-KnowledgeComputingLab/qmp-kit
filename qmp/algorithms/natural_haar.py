    ...
    def main(self, *, model_param: typing.Any = None, network_param: typing.Any = None) -> None:
        ...
        while True:
            ...
            for target_energy, configs, original_psi in _DynamicLanczos(
                ...
                data["haar"]["lanczos"] += 1
            hamiltonian_original_psi = model.apply_within(configs, original_psi, configs)
            energy = (original_psi.conj() @ hamiltonian_original_psi) / (original_psi.conj() @ original_psi)
            reweighted_factor = hamiltonian_original_psi - energy * original_psi
...
subcommand_dict["natural-haar"] = HaarConfig
